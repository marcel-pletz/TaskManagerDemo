...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     */
    authCurrentUserList: (params: RequestParams = {}) =>
     ...
     */
    todosCreate: (data: TodoCommandDto, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/todos`,
        method: "POST",
        body: data,
     ...
     */
    todosUpdate: (id: string, data: TodoCommandDto, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/todos/${id}`,
        method: "PUT",
        body: data,
     ...
     *
     * @tags Todo
     * @name TodosStartProgressCreate
     * @request POST:/api/todos/{id}/start-progress
     */
    todosStartProgressCreate: (id: string, params: RequestParams = {}) =>
      this.request<void, any>({
     ...
     *
     * @tags Todo
     * @name TodosFinishCreate
     * @request POST:/api/todos/{id}/finish
     */
    todosFinishCreate: (id: string, params: RequestParams = {}) =>
      this.request<void, any>({
